...
MY_ROOT="${CONFIG_DIR}/.."
IMAGE_FILE="${MY_ROOT}/arc.img"
BOARD_PATH="${CONFIG_DIR}/board/arc"
...
echo "Copying files"
sudo cp -v "${BINARIES_DIR}/bzImage" "${BINARIES_DIR}/p3/bzImage-arc"
sudo cp -v "${BINARIES_DIR}/rootfs.cpio.xz" "${BINARIES_DIR}/p3/initrd-arc"
sudo cp -Rv "${BOARD_PATH}/p1/"* "${BINARIES_DIR}/p1"
sudo cp -Rv "${BOARD_PATH}/p3/"* "${BINARIES_DIR}/p3"
sync
