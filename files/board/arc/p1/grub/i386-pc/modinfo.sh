...
# Build environment
<<<<<<< HEAD:files/board/arc/p1/grub/i386-pc/modinfo.sh
...
grub_target_nm='nm'
>>>>>>> 31c16c7 (Grub2: bump version to 2.06, added EFI32):files/board/arpl/p1/grub/i386-pc/modinfo.sh
